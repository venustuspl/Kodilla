...
public class CrudAppTestingApp {
    ...
    public static final String XPATH_SELECT_WAIT_FOR = "//select[1]";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://venustuspl.github.io");
        ...
        while (!driver.findElement(By.xpath(XPATH_SELECT_WAIT_FOR)).isDisplayed()) ;
